...
def run_batch(args, cwd=BASE_DIR):
    ...
    (progn
        ...
        (with-temp-buffer
            (url-insert-file-contents "https://raw.githubusercontent.com/progfolio/elpaca/10e65441f34253254272aeacd300574b576894a2/doc/installer.el")
            (eval-buffer))

        (elpaca '(compat :fetcher github :repo "emacs-compat/compat" :commit "cccd41f549fa88031a32deb26253b462021d7e12"))
        (elpaca '(markdown-mode :fetcher github :repo "jrblevin/markdown-mode" :commit "d51c469133d220823cc6ab50ff8e8743ed6e42fb"))
        (elpaca '(yasnippet :fetcher github :repo "joaotavora/yasnippet" :commit "dd570a6b22364212fff9769cbf4376bdbd7a63c5"))
        (elpaca '(tempel :fetcher github :repo "minad/tempel" :commit "aa0f6fab4013d4661c34f9352531ceac1f0973a8"))
